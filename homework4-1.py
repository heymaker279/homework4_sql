    ...
    def filling_in_the_table():
        ...
        with open("Tracks.txt") as f:
            ...
            for i in file:
                ...
                time = float(i[1])
                album_id = int(i[2])
                connection.execute(f"""INSERT INTO track(track_name, track_time, album_id)
        ...
        with open("GenreArtists.txt") as f:
            ...
            for i in file:
                genre_id = int(i[0])
                artist_id = int(i[1])
                connection.execute(f"""INSERT INTO genreartists(genre_id, artist_id)
        ...
        with open("ArtistsAlbum.txt") as f:
            ...
            for i in file:
                artist_id = int(i[0])
                album_id = int(i[1])
                connection.execute(f"""INSERT INTO artistsalbums(artist_id, album_id)
